...
module Flowbite
  module Components
    ...
    # Run via rake task:
    #
    #     bin/rails flowbite_components:detect_legacy_slots
    #     bin/rails flowbite_components:migrate_legacy_slots
    #     bin/rails flowbite_components:migrate_legacy_slots app/views
    #
    # Or run via rails console if you need to pass custom paths:
    #
    #     Flowbite::Components::Codemods::V3SlotSetters.new(
